          ...
          <a class="nav-link" href="./main/app-email.html">Email</a>
            ...
            <div class="d-block d-lg-none py-4">
                ...
                <a href="./main/index.html" class="text-nowrap logo-img d-flex align-items-center">
                    ...
                    <!-- Logo -->
                    <img class="logo-icon" src="{{ asset('assets/images/logos/1.png') }}" width="45" alt="Logo">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar>
                                    ...
                                    <div class="d-flex gap-2 py-4 px-7 pt-8">
                                        ...
                                        <a href="/student/edit-password" class="btn btn-outline-primary">Ubah
                                            Password</a>
                                    </div>
                                </div>
                            </div>
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item d-none d-xl-block">
                    <a href="./main/index.html" class="text-nowrap logo-img d-flex align-items-center">
                        ...
                        <!-- Logo -->
                        <img class="logo-icon" src="{{ asset('assets/images/logos/1.png') }}" width="45"
                            alt="Logo">
