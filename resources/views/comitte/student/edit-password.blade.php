                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="/comitte/student">Daftar Siswa</a>
                                </li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-4 position-relative">
                    <h4 class="card-title mb-0">Ubah Password — {{ $student->name }}</h4>
                ...
                <form action="{{ route('comitte.student.editPassword', $student->usr_id) }}" method="POST">
                    @csrf
                    @method('PUT')
