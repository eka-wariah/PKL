                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <a href="/comitte/student" class="btn btn-secondary">
                        ...
                        <form action="{{ route('comitte.student.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                <a href="/comitte/student" class="btn btn-secondary">Batal</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ol class="ps-3 small text-muted">
                            <li class="mb-2">Pastikan <strong>data Jurusan, Kelas, dan Perusahaan </strong> telah <strong> tersedia dan diperbarui </strong> sebelum melakukan proses import data siswa.</li>
                        ...
                        <table class="table table-sm table-bordered small">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><code>perusahaan</code></td>
                                    <td>Perusahaan tempat siswa melaksanakan PKL</td>
                                </tr>
                                <tr>
                                    <td><code>nickname</code></td>
                                    <td>Nama panggilan siswa</td>
                                </tr>
                            </tbody>
                        </table>

                        <a href="{{ route('comitte.student.template') }}" class="btn btn-success w-100 mt-2">
