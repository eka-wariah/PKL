...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('news', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('news_student_nis');
            $table->foreign('news_student_nis')->references('std_id')->on('students')->onDelete('cascade');
            ...
            $table->date('news_ended')->nullable();
            $table->string('news_document_number')->nullable();
            $table->string('news_week_number')->nullable();
            $table->string('news_guidance_material')->nullable();
            $table->string('news_note')->nullable();
            $table->string('news_problem')->nullable();
